...
The global distribution of permanent WSPR receive sites concentrates mainly on the US and central Europe. Outside of these regions there are many dark Spots. This is cleary made visible in this [Time lapse Vdeo](https://youtu.be/DwP9e7xMAVY) taken on August-6 2021. For Propagation studies it is crucial to establish a well distributed global network of WSPR RX Monitors. This is Phase II of the Project.

The details of the WSPR Monitor System is currently being worked out. For now it consists of an Airspy HF+ Discovery and a Raspberri Pi running a customized OS image, tailored for the WSPR Monitor. A description can be found [here](https://docs.google.com/document/d/e/2PACX-1vQwBbkGgE0oMXaGkVrAFNZtFjnylsCQre2WHf2CIEDpuUj8EZDj8jMv2VJoJ-nuQoM-AH1lTd7GsYEq/pub).
