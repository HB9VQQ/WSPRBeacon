...
Ready-to-use self-contained (No PC required) WSPR Beacon Transmitters covering the 80,40,30,20,15,12 and 10m Band and running the special Beacon Firmware should be available by the End of June 2021 (limited quantity). These Transmitters are purpose built devices for the WSPRBeacon Project by Harry @Zachtek and are not available off-the-shelf with the indicated Band coverage. Power output ~200mW.
