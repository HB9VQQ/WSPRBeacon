...
Goal is to establish a globall Network of permanently installed, standardized, easy to operate, inexpensive and self-contained WSPR Beacons running 24x7x365, sharing the same or a very similar Setup:
...
Customized ready-to-use WSPR Beacon Transmitters covering the above mentioned Bands and running the Beacon Firmware will be made available at a later stage of the Project.
