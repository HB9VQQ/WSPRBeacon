...
Goal is to establish a global Network of permanently installed and standardized, easy to operate, inexpensive and self-contained WSPR Beacons running 24x7x365, sharing the same or a very similar Setup:
